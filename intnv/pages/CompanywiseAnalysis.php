<?php
   ...
   <!--end of nava bar-->
        <div id="page-wrapper">
            <div class="row">
            	<div class="col-lg-12">
                    <h1 class="page-header">Analyse Boats / CompanyWise</h1>
                    <div class="col-lg-3">
				  <form data-toggle="validator" class="form-horizontal" role="form" name="disable" style="margin-top:20px;" action="/intnv/pages/charts/LibChart/company.php" method="get" id="disable" enctype="multipart/form-data">
									  ...
									  if ($result->num_rows > 0) {
										echo '<div class="form-group">';
									  	echo '<label for="dur">Company</label>';
										echo '<select class="form-control" id="dur" name="dur">';
