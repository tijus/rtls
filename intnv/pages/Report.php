        ...
        <div id="page-wrapper">
            <div class="row">
            	<div class="col-lg-12">
                    ...
                    <div class="col-lg-3">
				  <form data-toggle="validator" class="form-horizontal" role="form" name="disable" style="margin-top:20px;" action="GenerateReport.php" method="get" id="disable" enctype="multipart/form-data">
